...
W1 = tf.get_variable("W1", shape = [784, 522], initializer = tf.initializers.he_normal(seed=None))
W2 = tf.get_variable("W2", shape = [522, 261], initializer = tf.initializers.he_normal(seed=None))
W3 = tf.get_variable("W3", shape = [261, 10], initializer = tf.initializers.he_normal(seed=None))
