...
W1 = tf.get_variable("W1", shape = [784, 588], initializer = tf.contrib.layers.xavier_initializer())
W2 = tf.get_variable("W2", shape = [588, 392], initializer = tf.contrib.layers.xavier_initializer())
W3 = tf.get_variable("W3", shape = [392, 196], initializer = tf.contrib.layers.xavier_initializer())
W4 = tf.get_variable("W4", shape = [196, 10], initializer = tf.contrib.layers.xavier_initializer())
