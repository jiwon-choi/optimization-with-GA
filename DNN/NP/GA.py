...
def selection(popRanked, eliteSize):
    ...
    '''
            ...
            0      1      300      300    45.454545
            1      3      200      500    75.757576
            2      5      100      600    90.909091
            3      4       50      650    98.484848
            4      2       10      660   100.000000
...
def breed(parent1, parent2):
    ...
    return child
    '''
    부모A로부터 무작위 만큼 유전자를 잘라내고 남은 공간을 부모B에게서 겹치지 않게 받아온다.
    교차?
    '''
...
def breedPopulation(matingpool, eliteSize):
    ...
    return children
    '''
    엘리트들을 다음세대로 보내고 부족한 나머지 자리를 엘리트들을 교배하여 낳은 자식들로 채운
    '''
